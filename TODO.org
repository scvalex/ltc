...
* DONE Custom Type Test
  ...
  :END:
* TODO Configurable monkey
* TODO Expose net/monkey config in web interface
...
* DONE Multi-entry changes
  ...
  - [X] mget
* TODO Better merging
* TODO Recoverable store state
  - [ ] Was store closed cleanly?
  - [ ] A list of all the changes made to a store (to speed up
    computations for updates).
